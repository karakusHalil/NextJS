...
const MainSearch = () => {
  ...
  const handleSearch = () => {
    const query = new URLSearchParams(formValue).toString();
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Select
          defaultValue={formValue.activity}
        ...
        <Button
          ...
          className="ml-5 bg-orange-500 text-white hover:bg-orange-600 py-6 w-auto"
        >
          Find Now
        </Button>
      </div>
